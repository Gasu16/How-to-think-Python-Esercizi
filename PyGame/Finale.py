...
NEXT STEP: 
1 - SISTEMARE IL METODO DI INCREMENTO DEL PUNTEGGIO
    IL PUNTEGGIO RIMANE FISSO A 1
"""
...
class GamePlayer:
    ...
    def screenCollision(self):
        if self.Rpos.x <= 0 or self.Rpos.y >= 450 or self.Rpos.x >= 630 or self.Rpos.y <= 0:
            return True
...
#            screen.blit(background, o.pos, o.pos) # Ridisegniamo ogni volta lo sfondo
        ...
        for o in nemici:
            ...
            if o.pos.colliderect(r.Rpos):
                ...
                p.stop()
                menu_punteggio = myfont.render("PUNTEGGIO: " + p.__str__(), 1, (0, 0, 233))
                screen.blit(menu_punteggio, (100, 80))
